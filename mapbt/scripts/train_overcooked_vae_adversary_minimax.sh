...
num_agents=2
algo="adaptive"
exp="coordinator_vs_adversary_minimax_kl_0.1"
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=$1 python overcooked_population/train_coordinator_vs_adversary.py \
        ...
        --vae_z_change_prob 0 \
        --adversary_type min --adversary_learning_rate 0.001 --use_lr_scheduler --start_facttor 1.0 --end_factor 0.9 \
        --use_kl --kl_coeff 0.1 \
        --use_std_scaling \
