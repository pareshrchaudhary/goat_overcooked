...
def parse_args(args, parser):
    ...
    # adversary type 
    parser.add_argument("--adversary_type", default="max", choices=["max", "min"], help="the type of the adversary")
    ...
    parser.add_argument("--kl_coeff", default=0.01, type=float, help="beta for kl constraint")
...
def main(args):
    ...
    if all_args.use_wandb:
        run = wandb.init(config=all_args,
                         ...
                         group="coordinator_vs_adversary_"+all_args.layout_name,
                         dir=str(run_dir),
    ...
    if all_args.share_policy:
        from mapbt.scripts.overcooked_population.adversarial.shared_runner import OvercookedRunner as Runner
    else:
        raise NotImplementedError
