...
def parse_args(args, parser):
    ...
    parser.add_argument("--vae_z_generator", type=str, default="normal_gaussian", choices=["normal_gaussian", "human_biased", "human_biased_std"], help="the type of the z generator")
...
def main(args):
    ...
    if all_args.use_wandb:
        run = wandb.init(config=all_args,
                         ...
                         group="coordinator_vs_vae_"+all_args.layout_name,
                         dir=str(run_dir),
