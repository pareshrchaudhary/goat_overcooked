...
run_path=./results/Overcooked/diverse_counter_circuit_6x5/adaptive/vae_sp_vs_minimax_regret_kl_46_mean_clip_max_0.2_min_0.2/seed3
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=$1 python overcooked_population/render_vae_xp.py \
